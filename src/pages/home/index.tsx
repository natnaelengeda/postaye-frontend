...
export default function Home(props: any) {
  ...
  const submitDetails = async (data: any) => {
    ...
    axios.post(url + '/api/v1/waitlist', data).then((res) => {
      if (res.status == 200) {
    ...
    <div className='container mx-auto font-Nunito'>
      <div className='grid grid-cols-1  md:grid-cols-2 gap-10 items-center justify-center px-5 md:px-20'>
        ...
        <div className='w-full flex items-center justify-center'>
          <div className={`mb-4 w-full md:w-3/4 py-5 h-auto bg-white rounded-xl flex flex-col gap-2  ${clicked ? 'glow' : ''}`}>
            ...
            <div className=' '>
              ...
              <div className="w-full  sm:p-6 md:p-8 px-4 md:px-5">
                <form className='space-y-6' onSubmit={handleSubmit(submitDetails)}>
                  <div>
